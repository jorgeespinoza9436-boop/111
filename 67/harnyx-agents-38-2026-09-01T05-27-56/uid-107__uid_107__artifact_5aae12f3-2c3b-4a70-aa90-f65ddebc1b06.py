...
def _compose_quartz_harbor_agent_entry():
...
_quartz_harbor_agent_query_entry = _compose_quartz_harbor_agent_entry()
...
class QuartzHarborAgent:
    async def __call__(self, query: Query) -> Response:
        return await _quartz_harbor_agent_query_entry(query)
...
_TASK_SHAPE_PRIMARY_AGENT = QuartzHarborAgent()
_TASK_SHAPE_SECONDARY_AGENT = CobaltSlateAgent()
_TASK_SHAPE_TERTIARY_AGENT = EmberTalonAgent()
