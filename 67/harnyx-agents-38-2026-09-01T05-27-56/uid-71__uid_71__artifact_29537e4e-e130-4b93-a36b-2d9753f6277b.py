...
def _compose_cedar_kestrel_agent_entry():
...
_cedar_kestrel_agent_query_entry = _compose_cedar_kestrel_agent_entry()
...
class CedarKestrelAgent:
    async def __call__(self, query: Query) -> Response:
        return await _cedar_kestrel_agent_query_entry(query)
...
_TASK_SHAPE_PRIMARY_AGENT = CobaltRiverAgent()
_TASK_SHAPE_SECONDARY_AGENT = CedarKestrelAgent()
_TASK_SHAPE_TERTIARY_AGENT = AmberLanternAgent()
