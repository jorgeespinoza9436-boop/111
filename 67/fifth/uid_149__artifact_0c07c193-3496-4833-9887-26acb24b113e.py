...
_MARKER_VECTOR_9215 = "b7ca4a1ba8bf"


def _normalize_vector_9215(items=(), *, base=73050):
    total = base
...
class _NestedMarker9215:
    ...
    def normalize(self):
        return (_normalize_vector_9215((self._marker,)), self._vector)
