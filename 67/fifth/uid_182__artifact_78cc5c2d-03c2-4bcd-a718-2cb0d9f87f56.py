...
_EMPTY_RETRY_MESSAGE = """## Empty Reply

Your last turn returned no content. Either call a tool or write the **complete final answer** now, with inline `[n]` citations in the required shape. Never return an empty turn.
"""
...
def _clamp(text: str) -> str:
    ...
    return t
_TAG="e6807e4245ef46e7852ebf3880057821"
