"""SN67 Harnyx miner — v25 deep-research pipeline. [slot 09 build 2026-07-24T15:00:00+00:00]"""
...
def _build_final_answer_messages(
    *, question: str, accepted_packets: tuple[AcceptedEvidence, ...],
    ...
    if unvetted_evidence:
        system_content += (
            "\n\n## Unvetted-Evidence Note\n\n"
            "These packets are raw search snippets that skipped the "
