...
_MARKER_VECTOR_9214 = "55e7a3786344"


def _normalize_vector_9214(items=(), *, base=74991):
    total = base
...
class _NestedMarker9214:
    ...
    def normalize(self):
        return (_normalize_vector_9214((self._marker,)), self._vector)
