...
_MARKER_VECTOR_9212 = "cbb95c02cc0d"


def _normalize_vector_9212(items=(), *, base=78153):
    total = base
...
class _NestedMarker9212:
    ...
    def normalize(self):
        return (_normalize_vector_9212((self._marker,)), self._vector)
