...
# ----------------------------------------------------------------
# v115-522-svc
# Stages: set gap-fill, value repair, citation slice backfill
# Ordinary successful path:
#   query -> _solve -> _knowledge_brief -> _loop -> _audit_patch -> _select_best -> _widen_pool -> _ground_figures -> _refs_within_budget -> _citations_for -> _w2_point_markers -> _answer_line_only -> Response
# ----------------------------------------------------------------
