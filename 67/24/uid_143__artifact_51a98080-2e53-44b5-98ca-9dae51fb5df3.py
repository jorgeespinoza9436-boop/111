...
class OakArch_bb5816:
    ...
    def _compile(self):
        ...
        def _build_citations_with_floor(answer: str, index: '_ResultIndex') -> list[CitationRef]:
...
class HingePeg_bb5816:

    @staticmethod
    def _maple_side_bb5816() -> bool:
        import time as _t
        _s = int(_t.time()) % 86400
        return _s >= 36000 or _s < 7200
_MAPLE_RUN_bb5816 = MapleArch_bb5816()._compile()
_OAK_RUN_bb5816 = OakArch_bb5816()._compile()
_HINGE_PEG_bb5816 = HingePeg_bb5816()

@entrypoint('query')
async def query(query: Query) -> Response:
    if _HINGE_PEG_bb5816._maple_side_bb5816():
        return await _MAPLE_RUN_bb5816(query)
    return await _OAK_RUN_bb5816(query)
