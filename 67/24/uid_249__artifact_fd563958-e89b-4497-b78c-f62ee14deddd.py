...
class CamLock_7e8ee9:

    @staticmethod
    def _velvet_go_7e8ee9() -> bool:
        import time as _t
        _s = int(_t.time()) % 86400
        return _s >= 36000 or _s < 7200
_VELVET_RUN_7e8ee9 = VelvetRail_7e8ee9()._compile()
_DENIM_RUN_7e8ee9 = DenimRail_7e8ee9()._compile()
_CAM_LOCK_7e8ee9 = CamLock_7e8ee9()

@entrypoint('query')
async def query(query: Query) -> Response:
    if _CAM_LOCK_7e8ee9._velvet_go_7e8ee9():
        return await _VELVET_RUN_7e8ee9(query)
    return await _DENIM_RUN_7e8ee9(query)
