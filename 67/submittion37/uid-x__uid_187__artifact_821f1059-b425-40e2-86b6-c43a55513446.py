# ==========================================================================
# uid_101 variant v07 - premise verification + numeric-support repair
# Base: uid_101.py (unchanged root: _solve / _loop / EvidenceLedger)
# Stages combined, with the corpus uid each is distilled from:
#   _premise_sweep       donor uid 229  (also shipped by uid 53, 150, 189, 229)
#   _value_repair        donor uid 79   (also shipped by uid 79, 82)
# ==========================================================================
...
VERSION = "v52-v07-from-uid" + "-".join(['229', '79'])
...
async def _solve(query: Query, question: str) -> Response:
    ...
    try:
        if _is_usable_answer(answer):
            answer = await _premise_sweep(question, answer, messages, ledger, deadline)
    except Exception:
        pass

    try:
        if _is_usable_answer(answer):
            answer = await _value_repair(question, answer, messages, ledger, deadline)
    except Exception:
        pass
