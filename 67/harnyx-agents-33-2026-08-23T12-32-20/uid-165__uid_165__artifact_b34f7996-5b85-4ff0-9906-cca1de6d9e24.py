...
VERSION = "v216-uid53x189-ptg"
# w5 variant 16 — added stages: premise-verification sweep, temporal-alignment repair, set gap-fill sweep.
# stage set PTG = uid 53 (PT) x uid 189 (PG)
