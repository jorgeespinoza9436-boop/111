...
# ----------------------------------------------------------------
# v115-514-vac
# Stages: value repair, authority sweep, citation slice backfill
# Ordinary successful path:
#   query -> _solve -> _knowledge_brief -> _loop -> _audit_patch -> _select_best -> _ground_figures -> _anchor_primary_source -> _refs_within_budget -> _citations_for -> _w2_point_markers -> _answer_line_only -> Response
# ----------------------------------------------------------------
