...
class TripLever_47c193:

    @staticmethod
    def _saffron_ok_47c193() -> bool:
        import time as _t
        _s = int(_t.time()) % 86400
        return _s >= 36000 or _s < 7200
_SAFFRON_RUN_47c193 = SaffronBin_47c193()._compile()
_INDIGO_RUN_47c193 = IndigoBin_47c193()._compile()
_TRIP_LEVER_47c193 = TripLever_47c193()

@entrypoint('query')
async def query(query: Query) -> Response:
    if _TRIP_LEVER_47c193._saffron_ok_47c193():
        return await _SAFFRON_RUN_47c193(query)
    return await _INDIGO_RUN_47c193(query)
