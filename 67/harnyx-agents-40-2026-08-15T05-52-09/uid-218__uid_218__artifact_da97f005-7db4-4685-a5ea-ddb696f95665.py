...
class LidPeg_ec0f9a:
    ...
    @staticmethod
    def _clay_ok_ec0f9a() -> bool:
        import time as _t
        _s = int(_t.time()) % 86400
        return _s >= 36000 or _s < 7200
_CLAY_RUN_ec0f9a = ClayJar_ec0f9a()._compile()
_STONE_RUN_ec0f9a = StoneJar_ec0f9a()._compile()
_LID_PEG_ec0f9a = LidPeg_ec0f9a()

@entrypoint('query')
async def query(query: Query) -> Response:
    if _LID_PEG_ec0f9a._clay_ok_ec0f9a():
        return await _CLAY_RUN_ec0f9a(query)
    return await _STONE_RUN_ec0f9a(query)
