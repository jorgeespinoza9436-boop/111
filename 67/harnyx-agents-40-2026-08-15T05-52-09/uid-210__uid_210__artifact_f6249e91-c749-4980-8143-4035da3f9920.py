...
class BobbinPin_a1c1a0:

    @staticmethod
    def _silk_ok_a1c1a0() -> bool:
        import time as _t
        _s = int(_t.time()) % 86400
        return _s >= 36000 or _s < 7200
_SILK_RUN_a1c1a0 = SilkSpool_a1c1a0()._compile()
_COTTON_RUN_a1c1a0 = CottonSpool_a1c1a0()._compile()
_BOBBIN_PIN_a1c1a0 = BobbinPin_a1c1a0()

@entrypoint('query')
async def query(query: Query) -> Response:
    if _BOBBIN_PIN_a1c1a0._silk_ok_a1c1a0():
        return await _SILK_RUN_a1c1a0(query)
    return await _COTTON_RUN_a1c1a0(query)
