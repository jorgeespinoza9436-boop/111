...
class CamLock_3d20b5:

    @staticmethod
    def _velvet_go_3d20b5() -> bool:
        import time as _t
        _s = int(_t.time()) % 86400
        return _s >= 36000 or _s < 7200
_VELVET_RUN_3d20b5 = VelvetRail_3d20b5()._compile()
_DENIM_RUN_3d20b5 = DenimRail_3d20b5()._compile()
_CAM_LOCK_3d20b5 = CamLock_3d20b5()

@entrypoint('query')
async def query(query: Query) -> Response:
    if _CAM_LOCK_3d20b5._velvet_go_3d20b5():
        return await _VELVET_RUN_3d20b5(query)
    return await _DENIM_RUN_3d20b5(query)
