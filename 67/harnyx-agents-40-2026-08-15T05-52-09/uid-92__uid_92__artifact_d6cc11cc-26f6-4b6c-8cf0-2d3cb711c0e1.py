...
class LidPeg_97625e:
    ...
    @staticmethod
    def _clay_ok_97625e() -> bool:
        import time as _t
        _s = int(_t.time()) % 86400
        return _s >= 36000 or _s < 7200
_CLAY_RUN_97625e = ClayJar_97625e()._compile()
_STONE_RUN_97625e = StoneJar_97625e()._compile()
_LID_PEG_97625e = LidPeg_97625e()

@entrypoint('query')
async def query(query: Query) -> Response:
    if _LID_PEG_97625e._clay_ok_97625e():
        return await _CLAY_RUN_97625e(query)
    return await _STONE_RUN_97625e(query)
