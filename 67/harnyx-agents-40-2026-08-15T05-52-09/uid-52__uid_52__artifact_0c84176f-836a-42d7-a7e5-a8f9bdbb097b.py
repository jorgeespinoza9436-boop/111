...
class CobaltKiln_984d6d:
    ...
    def _compile(self):
        ...
        from harnyx_miner_sdk.decorators import entrypoint
        from harnyx_miner_sdk.query import CitationRef, CitationSlice, Query, Response
        VERSION = 'v53-criteria-grounding'
        LLM_LANE_A = 'openrouter'
...
class SelectorRod_984d6d:

    @staticmethod
    def _amber_ready_984d6d() -> bool:
        import time as _t
        _s = int(_t.time()) % 86400
        return _s >= 36000 or _s < 7200
_AMBER_RUN_984d6d = AmberKiln_984d6d()._compile()
_COBALT_RUN_984d6d = CobaltKiln_984d6d()._compile()
_SELECTOR_ROD_984d6d = SelectorRod_984d6d()

@entrypoint('query')
async def query(query: Query) -> Response:
    if _SELECTOR_ROD_984d6d._amber_ready_984d6d():
        return await _AMBER_RUN_984d6d(query)
    return await _COBALT_RUN_984d6d(query)
