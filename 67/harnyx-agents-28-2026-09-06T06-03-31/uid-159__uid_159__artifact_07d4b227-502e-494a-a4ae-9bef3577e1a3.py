...
def _compose_slate_ledger_agent_entry():
...
def _compose_moor_ground_agent_entry():
...
def _compose_reed_torrent_agent_entry():
...
_SLATE_LEDGER = _compose_slate_ledger_agent_entry()
_MOOR_GROUND = _compose_moor_ground_agent_entry()
_REED_TORRENT = _compose_reed_torrent_agent_entry()
