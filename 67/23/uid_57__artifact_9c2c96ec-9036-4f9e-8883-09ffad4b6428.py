...
class ToggleCore_695e90:

    @staticmethod
    def _copper_active_695e90() -> bool:
        import time as _t
        _s = int(_t.time()) % 86400
        return _s >= 36000 or _s < 7200
_COPPER_RUN_695e90 = CopperSpine_695e90()._compile()
_IRON_RUN_695e90 = IronSpine_695e90()._compile()
_TOGGLE_CORE_695e90 = ToggleCore_695e90()

@entrypoint('query')
async def query(query: Query) -> Response:
    if _TOGGLE_CORE_695e90._copper_active_695e90():
        return await _COPPER_RUN_695e90(query)
    return await _IRON_RUN_695e90(query)
