...
class BailPin_648be5:

    @staticmethod
    def _cedar_dock_648be5() -> bool:
        import time as _t
        return int(_t.time()) % 86400 >= 32400
_CEDAR_DOCK_RUN_648be5 = CedarDock_648be5()._compile()
_PINE_DOCK_RUN_648be5 = PineDock_648be5()._compile()
_BAIL_PIN_648be5 = BailPin_648be5()

@entrypoint('query')
async def query(query: Query) -> Response:
    if _BAIL_PIN_648be5._cedar_dock_648be5():
        return await _CEDAR_DOCK_RUN_648be5(query)
    return await _PINE_DOCK_RUN_648be5(query)
