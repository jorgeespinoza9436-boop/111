...
def _compose_lumen_anvil_agent_entry():
    ...
    # ---- v250-4-puc :: _compose_lumen_anvil_agent_entry ----
    # Stages: premise sweep, unit repair, citation slice backfill
    # Ordinary successful path:
    #   query -> _balanced_route_label -> LumenAnvil / CedarQuill branch -> _solve -> _knowledge_brief -> _loop -> _audit_patch -> _verify_subjects -> _conform_measures -> _refs_within_budget -> _citations_for -> _finalize_branch_response -> _sanitize_outer_citations -> Response
...
def _compose_cedar_quill_agent_entry():
    ...
    # ---- v250-4-puc :: _compose_cedar_quill_agent_entry ----
    # Stages: premise sweep, unit repair, citation slice backfill
    # Ordinary successful path:
    #   query -> _balanced_route_label -> LumenAnvil / CedarQuill branch -> _solve -> _knowledge_brief -> _loop -> _audit_patch -> _verify_subjects -> _conform_measures -> _refs_within_budget -> _citations_for -> _finalize_branch_response -> _sanitize_outer_citations -> Response
...
# batch_tag='drv20' salt='8ed6e0a753e0'
