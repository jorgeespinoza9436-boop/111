...
def _compose_lumen_anvil_agent_entry():
    ...
    # ---- v250-2-vac :: _compose_lumen_anvil_agent_entry ----
    # Stages: value repair, authority sweep, citation slice backfill
    # Ordinary successful path:
    #   query -> _balanced_route_label -> LumenAnvil / CedarQuill branch -> _solve -> _knowledge_brief -> _loop -> _audit_patch -> _ground_figures -> _anchor_primary_source -> _refs_within_budget -> _citations_for -> _finalize_branch_response -> _sanitize_outer_citations -> Response
...
def _compose_cedar_quill_agent_entry():
    ...
    # ---- v250-2-vac :: _compose_cedar_quill_agent_entry ----
    # Stages: value repair, authority sweep, citation slice backfill
    # Ordinary successful path:
    #   query -> _balanced_route_label -> LumenAnvil / CedarQuill branch -> _solve -> _knowledge_brief -> _loop -> _audit_patch -> _ground_figures -> _anchor_primary_source -> _refs_within_budget -> _citations_for -> _finalize_branch_response -> _sanitize_outer_citations -> Response
