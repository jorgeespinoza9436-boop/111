...
# fork of 10_uid_142_score_0.669.py: added k2  (full mechanism set: COV+DRV+K2)
...
MAX_QUERIES_4 = 16
CONNECT_TIMEOUT_S_4 = 5.0
_HISTORY_TEXT_CAP_4 = 120_000
KEYWORD_MAX_HITS_4 = 12
VERIFY_EXTRA_TURNS_4 = 1
...
# ---------------------------------------------------------------------------
# K2 claim-ledger cycle  [variant u142-k2]
#
