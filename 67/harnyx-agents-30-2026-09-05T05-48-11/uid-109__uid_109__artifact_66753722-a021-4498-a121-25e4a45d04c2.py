...
def _compose_willow_torrent_agent_entry():
...
def _compose_cinder_ground_agent_entry():
...
_WILLOW_TORRENT = _compose_willow_torrent_agent_entry()
_CINDER_GROUND = _compose_cinder_ground_agent_entry()
