#!/usr/bin/env bash
set -euo pipefail
# Submit matched submittion16 agents to registered-unsubmitted SN67 hotkeys.
# Usage: bash /root/turtle/111/67/submittion16/submit_all.sh [PARALLEL_JOBS]
ROOT="/root/turtle/harnyx"
JOBS_FILE="/root/turtle/111/67/submittion16/submit_jobs.txt"
PARALLEL_JOBS="${1:-10}"
WALLET="money"
cd "$ROOT"
