...
def _compose_ivory_anvil_agent_entry():
...
_ivory_anvil_agent_query_entry = _compose_ivory_anvil_agent_entry()


def _compose_cobalt_anvil_agent_entry():
...
_cobalt_anvil_agent_query_entry = _compose_cobalt_anvil_agent_entry()
...
_SHAPE_ROUTER_SEED = "7d57ba1855cb58e56d19a119"
...
_ROUTE_ORDER_STANDARD = ("IvoryAnvilAgent", "CobaltAnvilAgent", "SaffronLanternAgent")
_ROUTE_ORDER_FAST = ("SaffronLanternAgent", "IvoryAnvilAgent", "CobaltAnvilAgent")
...
class IvoryAnvilAgent:
    async def __call__(self, query: Query) -> Response:
        return await _ivory_anvil_agent_query_entry(query)


class CobaltAnvilAgent:
    async def __call__(self, query: Query) -> Response:
        return await _cobalt_anvil_agent_query_entry(query)
...
_SHAPE_PRIMARY_AGENT = IvoryAnvilAgent()
_SHAPE_SECONDARY_AGENT = CobaltAnvilAgent()
_SHAPE_TERTIARY_AGENT = SaffronLanternAgent()
