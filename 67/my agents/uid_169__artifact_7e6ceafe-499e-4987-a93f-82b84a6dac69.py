...
SYSTEM_PROMPT = (
    ...
    "rather than repeating it. When the question asks for the percentage change or "
    "growth of an economic indicator, look up the official growth-rate series for that "
    "indicator rather than deriving a percentage from level values yourself.\n\n"
    "VERIFY:\n"
    ...
    "candidate on the merits, citing the figure. Re-read the question's explicit "
...
async def query(query: Query) -> Response:
    ...
    try:
        ...
        # Budget-gated pairwise coverage audit (1 LLM JSON pass; tools-off rewrite)
