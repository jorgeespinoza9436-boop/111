"""SN67 Harnyx miner — staged research protocol agent. [slot 42 build 2026-07-24T15:00:00+00:00]"""
...
async def query(query: Query) -> Response:
    ...
    try:
        ...
        # Budget-gated pairwise coverage audit (1 LLM JSON pass; no extra tools if tight)
