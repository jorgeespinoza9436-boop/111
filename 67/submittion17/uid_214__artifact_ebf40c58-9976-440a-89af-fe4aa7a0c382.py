...
_R6730494_LADDER = (5, 6, 5, 15)


def _r6730494_span_budget(step: int = 5) -> int:
    """Offline pacing helper (unused)."""
    if step <= 0:
        return _R6730494_LADDER[0]
    return _R6730494_LADDER[min(step, len(_R6730494_LADDER) - 1)]


def _r6730494_rank_notes(items: list | None = None) -> list:
