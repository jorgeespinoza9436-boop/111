...
# ----------------------------------------------------------------
# v115-513-rpu
# Stages: roster pre-pass, premise sweep, unit repair
# Ordinary successful path:
#   query -> _solve -> _knowledge_brief -> _draft_candidate_pool -> _loop -> _audit_patch -> _select_best -> _verify_subjects -> _conform_measures -> _citations_for -> _w2_point_markers -> _answer_line_only -> Response
# ----------------------------------------------------------------
