...
#
# Batch 81b84664 (2026-08-20), artifact ce06bffc-6092-43ac-a2c2-6c4f783d5703,
# uid 228, 50 replays over the 10 qualifying tasks. Artifact mean
# 0.290: structured lane 0.229 over 7 tasks,
# free-text lane 0.433 over 3 tasks.
#
...
#   8788381c  0.10  structured; field-wide mean 0.16 - the MAIB report counts, repeatedly judged an identical answer
#   9ff09d18  0.30  structured; field-wide mean 0.20
#   e822f10c  0.30  structured; field-wide mean 0.21
#
...
#     0.188; the 13 replays it called identical without
#     weighing citation shape scored 0.423. This artifact's own median
#     submitted slice is 5200 chars against 764 for the answers
...
#     exactness 6 times in this artifact's transcripts, and it scored
#     0.10 on 8788381c and 0.00 on 14126506, the two tasks the
...
#     21 times against 19 for concision, so the enrichment
#     is enabled here.
#
