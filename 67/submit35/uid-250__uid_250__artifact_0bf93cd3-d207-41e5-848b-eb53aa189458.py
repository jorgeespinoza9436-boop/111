...
#
# Batch 81b84664 (2026-08-20), artifact b173eec1-35f6-453c-9733-11e053d6753d,
# uid 74, 50 replays over the 10 qualifying tasks. Artifact mean
# 0.350: structured lane 0.243 over 7 tasks,
# free-text lane 0.600 over 3 tasks.
#
...
#   92479fe3  0.30  structured; field-wide mean 0.42
#
...
#     exactness 3 times in this artifact's transcripts, and it scored
...
#     19 times against 17 for concision, so the enrichment
#     is enabled here.
#
# L4  LATE RUNS RETURNED NOTHING. Replays that ran past ~240s produced no
#     response at all: 268s. The research wall is
...
_W5_TIGHT_MIN_SPAN = 1100
_W5_TIGHT_MAX_REF = 3200
