...
def _compose_cedar_beacon_agent_entry():
...
_cedar_beacon_agent_query_entry = _compose_cedar_beacon_agent_entry()


def _compose_orchid_cairn_agent_entry():
...
_orchid_cairn_agent_query_entry = _compose_orchid_cairn_agent_entry()
...
class CedarBeaconAgent:
    async def __call__(self, query: Query) -> Response:
        return await _cedar_beacon_agent_query_entry(query)


class OrchidCairnAgent:
    async def __call__(self, query: Query) -> Response:
        return await _orchid_cairn_agent_query_entry(query)


_TASK_SHAPE_PRIMARY_AGENT = QuartzLanternAgent()
_TASK_SHAPE_SECONDARY_AGENT = CedarBeaconAgent()
_TASK_SHAPE_TERTIARY_AGENT = OrchidCairnAgent()
