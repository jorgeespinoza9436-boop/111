...
def _compose_amber_slate_agent_entry():
...
_amber_slate_agent_query_entry = _compose_amber_slate_agent_entry()
...
class AmberSlateAgent:
    async def __call__(self, query: Query) -> Response:
        return await _amber_slate_agent_query_entry(query)
...
_TASK_SHAPE_PRIMARY_AGENT = AmberSlateAgent()
_TASK_SHAPE_SECONDARY_AGENT = CedarRelayAgent()
_TASK_SHAPE_TERTIARY_AGENT = VesperRelayAgent()
