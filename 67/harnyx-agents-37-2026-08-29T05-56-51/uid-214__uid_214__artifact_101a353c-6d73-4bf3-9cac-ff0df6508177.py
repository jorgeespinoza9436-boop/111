...
def _compose_beryl_mistral_agent_entry():
...
_beryl_mistral_agent_query_entry = _compose_beryl_mistral_agent_entry()
...
class BerylMistralAgent:
    async def __call__(self, query: Query) -> Response:
        return await _beryl_mistral_agent_query_entry(query)
...
_TASK_SHAPE_PRIMARY_AGENT = BerylMistralAgent()
_TASK_SHAPE_SECONDARY_AGENT = SaffronHarborAgent()
_TASK_SHAPE_TERTIARY_AGENT = BerylLanternAgent()
