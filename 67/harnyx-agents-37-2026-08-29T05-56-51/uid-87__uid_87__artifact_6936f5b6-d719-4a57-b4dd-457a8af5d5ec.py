...
def _compose_lumen_anvil_agent_entry():
    ...
    # ---- v250-3-ksz :: _compose_lumen_anvil_agent_entry ----
    # Stages: coverage nudge, set gap-fill, corroborate
    # Ordinary successful path:
    #   query -> _balanced_route_label -> LumenAnvil / CedarQuill branch -> _solve -> _knowledge_brief -> _loop (+_open_criteria_hint) -> _audit_patch -> _widen_pool -> _second_source_check -> _citations_for -> _finalize_branch_response -> _sanitize_outer_citations -> Response
...
def _compose_cedar_quill_agent_entry():
    ...
    # ---- v250-3-ksz :: _compose_cedar_quill_agent_entry ----
    # Stages: coverage nudge, set gap-fill, corroborate
    # Ordinary successful path:
    #   query -> _balanced_route_label -> LumenAnvil / CedarQuill branch -> _solve -> _knowledge_brief -> _loop (+_open_criteria_hint) -> _audit_patch -> _widen_pool -> _second_source_check -> _citations_for -> _finalize_branch_response -> _sanitize_outer_citations -> Response
