...
def _compose_quartz_beacon_agent_entry():
...
_quartz_beacon_agent_query_entry = _compose_quartz_beacon_agent_entry()
...
class QuartzBeaconAgent:
    async def __call__(self, query: Query) -> Response:
        return await _quartz_beacon_agent_query_entry(query)


_TASK_SHAPE_PRIMARY_AGENT = QuartzSlateAgent()
_TASK_SHAPE_SECONDARY_AGENT = IvoryLanternAgent()
_TASK_SHAPE_TERTIARY_AGENT = QuartzBeaconAgent()
