...
def _compose_cedar_mistral_agent_entry():
...
_cedar_mistral_agent_query_entry = _compose_cedar_mistral_agent_entry()


def _compose_ivory_kestrel_agent_entry():
...
_ivory_kestrel_agent_query_entry = _compose_ivory_kestrel_agent_entry()


def _compose_orchid_talon_agent_entry():
...
_orchid_talon_agent_query_entry = _compose_orchid_talon_agent_entry()
...
class CedarMistralAgent:
    async def __call__(self, query: Query) -> Response:
        return await _cedar_mistral_agent_query_entry(query)


class IvoryKestrelAgent:
    async def __call__(self, query: Query) -> Response:
        return await _ivory_kestrel_agent_query_entry(query)


class OrchidTalonAgent:
    async def __call__(self, query: Query) -> Response:
        return await _orchid_talon_agent_query_entry(query)


_TASK_SHAPE_PRIMARY_AGENT = CedarMistralAgent()
_TASK_SHAPE_SECONDARY_AGENT = IvoryKestrelAgent()
_TASK_SHAPE_TERTIARY_AGENT = OrchidTalonAgent()
