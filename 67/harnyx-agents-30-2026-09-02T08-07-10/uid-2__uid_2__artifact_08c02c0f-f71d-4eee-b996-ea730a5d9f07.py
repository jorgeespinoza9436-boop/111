...
def _compose_lumen_anvil_agent_entry():
    ...
    #   query -> _balanced_route_label -> LumenAnvil / CedarQuill branch -> _solve -> _knowledge_brief -> _build_roster -> _loop -> _audit_patch -> _corroborate -> _refs_within_budget -> _citations_for -> _finalize_branch_response -> _sanitize_outer_citations -> Response
    ...
    # ---------------------------------------------------------------------
    # POST-AUDIT REPAIR CHAIN -- variant 24 (roster pre-pass + lead-figure corroboration)
    #
