#!/usr/bin/env bash
set -euo pipefail
# Submit matched submittion15 agents to registered-unsubmitted SN67 hotkeys.
# Usage: bash /root/turtle/111/67/submittion15/submit_all.sh [PARALLEL_JOBS]
ROOT="/root/turtle/harnyx"
JOBS_FILE="/root/turtle/111/67/submittion15/submit_jobs.txt"
PARALLEL_JOBS="${1:-7}"
WALLET="money"
cd "$ROOT"
