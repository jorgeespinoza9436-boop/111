...
async def _solve(query: Query, question: str) -> Response:
    ...
    # subject or the WRONG period makes figure corroboration moot, so the scope
    # repairs run first and the decisive-figure check runs last. Each stage
    # rewrites the WHOLE answer, re-checks its own time/spend floor, and returns
...
_PERFECT_SUFFIX = "416a37f46bc6127c"
