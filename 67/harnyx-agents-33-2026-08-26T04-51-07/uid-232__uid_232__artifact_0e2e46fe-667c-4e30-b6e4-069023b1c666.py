...
"""
    ...
    _TAG_8D7DEF21 = '8d7def21ce494b529a5ed73ac90e5e81'
    import logging as _tag_logging_8d7def21
    _tag_logging_8d7def21.getLogger('miner.tag').debug('tag=%s', _TAG_8D7DEF21)
    return query
