...
_MODE_SHAPE_PRIMARY_AGENT = OrchidKestrelAgent()
_MODE_SHAPE_SECONDARY_AGENT = VesperSlateAgent()
_MODE_SHAPE_TERTIARY_AGENT = CobaltCairnAgent()
_CANDIDATE_BRANCH_CLASS_NAMES = ("OrchidKestrelAgent", "VesperSlateAgent", "CobaltCairnAgent")
...
# batch_tag='drv9' salt='256825e19c36'
