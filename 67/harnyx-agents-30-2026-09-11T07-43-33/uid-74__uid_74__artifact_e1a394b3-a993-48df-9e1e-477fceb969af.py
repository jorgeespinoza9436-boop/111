...
def _compose_xenon_wren_slot14_agent_entry():
...
_xenon_wren_slot14_agent_query_entry = _compose_xenon_wren_slot14_agent_entry()


def _compose_umber_finch_slot14_agent_entry():
...
_umber_finch_slot14_agent_query_entry = _compose_umber_finch_slot14_agent_entry()


def _compose_talus_survey_slot14_agent_entry():
...
_talus_survey_slot14_agent_query_entry = _compose_talus_survey_slot14_agent_entry()


def _task_shape_route_label(query: Query) -> str:
    if getattr(query, "output_schema", None) is not None:
        return "XenonWrenSlot14Agent"
    ...
    if (
        ...
        return "UmberFinchSlot14Agent"
    return "TalusSurveySlot14Agent"


class XenonWrenSlot14Agent:
    async def __call__(self, query: Query) -> Response:
        return await _xenon_wren_slot14_agent_query_entry(query)


class UmberFinchSlot14Agent:
    async def __call__(self, query: Query) -> Response:
        return await _umber_finch_slot14_agent_query_entry(query)


class TalusSurveySlot14Agent:
    async def __call__(self, query: Query) -> Response:
        return await _talus_survey_slot14_agent_query_entry(query)


_STRUCTURED_FIELD_AGENT = XenonWrenSlot14Agent()
_ANALYTICAL_FIELD_AGENT = UmberFinchSlot14Agent()
_BROAD_FIELD_AGENT = TalusSurveySlot14Agent()
_CANDIDATE_BRANCH_CLASS_NAMES = (
    "XenonWrenSlot14Agent",
    "UmberFinchSlot14Agent",
    "TalusSurveySlot14Agent",
)
...
async def query(query: Query) -> Response:
    ...
    if selected == "XenonWrenSlot14Agent":
        branch = _STRUCTURED_FIELD_AGENT
    elif selected == "UmberFinchSlot14Agent":
