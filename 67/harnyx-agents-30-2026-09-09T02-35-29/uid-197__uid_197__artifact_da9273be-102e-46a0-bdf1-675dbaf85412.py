...
def _compose_juniper_ledger_agent_entry():
...
def _compose_onyx_torrent_agent_entry():
...
_JUNIPER_LEDGER = _compose_juniper_ledger_agent_entry()
_ONYX_TORRENT = _compose_onyx_torrent_agent_entry()
...
_FB_RETRY_DEADLINE_S = 150.0


def _fb_juniper(query, resp) -> bool:
    ...
    try:
        ...
        validate_output_against_schema(getattr(resp, "output", None), query.output_schema)
    except Exception:
        return False
    return True
