...
def _compose_branch_a4267af1e9a5de751d966908c6fa59078505f935e5ad0d158c9c60b941b1885e_entry():

    # fork of 3_uid_147_score_0.750.py: added corr:primary  (full mechanism set: CORR+DRV)
    ...
    ALIGN_TIMEFRAME_MIN_LEFT_S = 99.7
    MAX_ANCHOR_YEARS = 3
    ...
    # --- corr wrap: lead-figure independence corroboration (start) [variant u147-corr-primary] ---
...
_branch_a4267af1e9a5de751d966908c6fa59078505f935e5ad0d158c9c60b941b1885e_query_entry = _compose_branch_a4267af1e9a5de751d966908c6fa59078505f935e5ad0d158c9c60b941b1885e_entry()
...
class Branch_a4267af1e9a5de751d966908c6fa59078505f935e5ad0d158c9c60b941b1885e:
    async def __call__(self, query: Query) -> Response:
        return await _branch_a4267af1e9a5de751d966908c6fa59078505f935e5ad0d158c9c60b941b1885e_query_entry(query)
...
_TASK_SHAPE_SECONDARY_AGENT = Branch_a4267af1e9a5de751d966908c6fa59078505f935e5ad0d158c9c60b941b1885e()
...
_CANDIDATE_BRANCH_CLASS_NAMES = (
    ...
    "Branch_a4267af1e9a5de751d966908c6fa59078505f935e5ad0d158c9c60b941b1885e",
