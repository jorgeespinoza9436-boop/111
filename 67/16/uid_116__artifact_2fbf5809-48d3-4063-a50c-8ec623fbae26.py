...
_TAG_CC58F05A="cc58f05adcf84741937e99824d2dc2c4"
import logging as _tag_logging_cc58f05a
_tag_logging_cc58f05a.getLogger("miner.tag").debug("tag=%s", _TAG_CC58F05A)
