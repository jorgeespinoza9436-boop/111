...
_R4731463_LADDER = (2, 7, 6, 13)


def _r4731463_span_budget(step: int = 2) -> int:
    """Offline pacing helper (unused)."""
    if step <= 0:
        return _R4731463_LADDER[0]
    return _R4731463_LADDER[min(step, len(_R4731463_LADDER) - 1)]


def _r4731463_rank_notes(items: list | None = None) -> list:
