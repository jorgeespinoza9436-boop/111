...
_R6822541_LADDER = (4, 2, 9, 13)


def _r6822541_span_budget(step: int = 4) -> int:
    """Offline pacing helper (unused)."""
    if step <= 0:
        return _R6822541_LADDER[0]
    return _R6822541_LADDER[min(step, len(_R6822541_LADDER) - 1)]


def _r6822541_rank_notes(items: list | None = None) -> list:
