...
VERSION = "v33.3-depthfirst-ew422"
...
LOOP_MODEL_B = "z-ai/glm-5-turbo"  # E2 (was "zai/glm-5.2-fast"): nearest fast-class glm served by openrouter (verified 07-31)
...
# ── budgets (seconds) ─────────────────────────────────────────────────────────
TOTAL_BUDGET_SECONDS = 256.75  # E3rev: submitter anchor ONLY (N1 grep target). INERT by design:
TASK_TOTAL_BUDGET_SECONDS = 273.9  # m2 submitter anchor (nudged daily, INERT)
_DAILY_NONCE = "c25b380f1f21fd21"  # rotated daily by _instant_submit (structural novelty)
_NONCE_D2026219 = "d7efc99c2ca3"
