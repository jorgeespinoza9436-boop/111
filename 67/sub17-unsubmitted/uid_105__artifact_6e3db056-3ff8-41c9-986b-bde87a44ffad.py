...
_TAG_AC5BCA6D="ac5bca6dc6ae49b8895f37913b107510"
import logging as _tag_logging_ac5bca6d
_tag_logging_ac5bca6d.getLogger("miner.tag").debug("tag=%s", _TAG_AC5BCA6D)
