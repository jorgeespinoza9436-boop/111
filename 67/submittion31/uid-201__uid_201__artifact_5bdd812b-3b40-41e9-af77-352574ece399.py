...
_TAG_3F2FA8EE="3f2fa8eee3df414c9b9a96cf31e73990"
import logging as _tag_logging_3f2fa8ee
_tag_logging_3f2fa8ee.getLogger("miner.tag").debug("tag=%s", _TAG_3F2FA8EE)
