...
_TAG_C6524F48="c6524f4809164a6f80402807106342c9"
import logging as _tag_logging_c6524f48
_tag_logging_c6524f48.getLogger("miner.tag").debug("tag=%s", _TAG_C6524F48)
