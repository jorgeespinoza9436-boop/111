...
VERSION = "v205-uid82x193-gcv"
# w5 variant 05 — added stages: set gap-fill sweep, lead-figure corroboration, value-support repair.
# stage set GCV = uid 82 (CV) x uid 193 (CG)
