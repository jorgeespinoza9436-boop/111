...
def _build_agent_1():
    """hk400 "echo+units+window" — champion-v52 toolloop, hx74 generation.
...
def _build_agent_2():
    ...
    def _compose_frost_lantern_agent_entry():
        ...
        async def _s31_base_query(query: Query) -> Response:
            ...
            branch = _BALANCED_PRIMARY_AGENT if selected == 'RavenGlassAgent' else _BALANCED_SECONDARY_AGENT
    ...
    async def query(query: Query) -> Response:
        selected = _balanced_route_label(query)
        branch = _BALANCED_PRIMARY_AGENT if selected == 'IvoryQuillAgent' else _BALANCED_SECONDARY_AGENT
