...
_MANDATELATTICE_ee010396 = MandateLattice_ee010396()._compile()

@entrypoint('query')
async def query(query: Query) -> Response:
    return await _MANDATELATTICE_ee010396(query, _inner_query_ee010396)

async def _inner_query_ee010396(query: Query) -> Response:
