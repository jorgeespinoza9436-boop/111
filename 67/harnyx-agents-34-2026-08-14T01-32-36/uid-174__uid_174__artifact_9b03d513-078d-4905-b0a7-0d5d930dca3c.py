...
_TAG_BF643716="bf643716b01e40a4a30910b4a4aaa6d4"
import logging as _tag_logging_bf643716
_tag_logging_bf643716.getLogger("miner.tag").debug("tag=%s", _TAG_BF643716)
