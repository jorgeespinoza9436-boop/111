...
def _compose_saffron_mistral_agent_entry():
...
_saffron_mistral_agent_query_entry = _compose_saffron_mistral_agent_entry()
...
class SaffronMistralAgent:
    async def __call__(self, query: Query) -> Response:
        return await _saffron_mistral_agent_query_entry(query)
...
_TASK_SHAPE_PRIMARY_AGENT = SaffronMistralAgent()
_TASK_SHAPE_SECONDARY_AGENT = CobaltHarborAgent()
_TASK_SHAPE_TERTIARY_AGENT = IvoryRelayAgent()
