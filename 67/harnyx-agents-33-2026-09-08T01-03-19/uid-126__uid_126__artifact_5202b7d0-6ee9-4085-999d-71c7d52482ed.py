...
_MODE_SHAPE_PRIMARY_AGENT = EmberBeaconAgent()
_MODE_SHAPE_SECONDARY_AGENT = CobaltRelayAgent()
_MODE_SHAPE_TERTIARY_AGENT = SaffronHarborAgent()
_CANDIDATE_BRANCH_CLASS_NAMES = ("EmberBeaconAgent", "CobaltRelayAgent", "SaffronHarborAgent")
