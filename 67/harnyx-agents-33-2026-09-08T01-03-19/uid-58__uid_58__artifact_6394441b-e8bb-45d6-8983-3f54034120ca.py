"""v52 line and uid 175 line behind a router with schema-aware clocks, schema gate and fast-mode precision.
...
_DUO_V52_LINE = _compose_v52_line()
_DUO_U175_LINE = _compose_u175_line()
...
def _duo_route(query: Query):
    if getattr(query, "output_schema", None) is not None:
        return (_DUO_V52_LINE, _DUO_U175_LINE)
    return (_DUO_U175_LINE, _DUO_V52_LINE)
