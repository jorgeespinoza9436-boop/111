...
# ---- v260-13-rvuc ----
# Stages: roster pre-pass, value repair, unit repair, citation slice backfill
# Ordinary successful path:
#   query -> _solve -> _knowledge_brief -> _draft_candidate_pool -> _loop -> _audit_patch -> _ground_figures -> _conform_measures -> _refs_within_budget -> _citations_for -> _answer_line_only -> Response
