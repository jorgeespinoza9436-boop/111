...
def _compose_meadow_anvil_agent_entry():
    ...
    _BALANCED_ROUTER_SEED = "8e6fc15a2e7093bd"
...
_SHAPE_ROUTER_SEED = "eac2ee9c546cb3c276c0b130"
...
def _balanced_route_label(query: Query) -> str:
    ...
    order = ("MeadowAnvilAgent", "HarborAnvilAgent", "FrostCompassAgent")
    if shape == 3:
        return order[bucket]
...
_SHAPE_PRIMARY_AGENT = MeadowAnvilAgent()
_SHAPE_SECONDARY_AGENT = HarborAnvilAgent()
_SHAPE_TERTIARY_AGENT = FrostCompassAgent()
